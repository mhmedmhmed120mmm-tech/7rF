...
export default function RoomRanksScreen() {
  ...
  const [newRankPassword, setNewRankPassword] = useState('');
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <Text style={styles.inputLabel}>كلمة مرور العضو</Text>

            <TextInput
              style={styles.input}
              placeholder="أدخل كلمة مرور خاصة بهذا العضو"
              placeholderTextColor="#71869A"
              value={newRankPassword}
              onChangeText={setNewRankPassword}
              secureTextEntry
              editable={!saving}
              autoCapitalize="none"
              autoCorrect={false}
