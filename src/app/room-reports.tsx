...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#101D2D', borderRadius: 14, borderWidth: 1, borderColor: '#29415A', padding: 16 },
  icon: { fontSize: 30, textAlign: 'center' },
  cardTitle: { color: '#FFFFFF', fontSize: 15, fontWeight: '800', textAlign: 'center', marginTop: 8 },
  cardText: { color: '#71869A', fontSize: 11, textAlign: 'center', marginTop: 5 },
  stats: { flexDirection: 'row', gap: 10, marginTop: 14 },
  stat: { flex: 1, backgroundColor: '#101D2D', borderRadius: 12, borderWidth: 1, borderColor: '#29415A', paddingVertical: 16, alignItems: 'center' },
  ...
  deleteButton: { marginTop: 16, height: 52, borderRadius: 12, backgroundColor: '#101D2D', borderWidth: 1, borderColor: '#5A2930', flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 8 },
